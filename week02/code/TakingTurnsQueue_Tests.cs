...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: AddPerson improperly adding to the start of the queue instead of the end.
    ...
    // Defect(s) Found: None were found in this test
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: No handling for infinite turns
    ...
    // Defect(s) Found: No handling for negative numbered turns
